...
const initAnimations = () => {
  document.querySelectorAll(".has-animation").forEach(element => {
    ...
    const autoPlay = element.getAttribute("data-auto-play-animation") === "true";
    ...
    const scrollTriggerStart = element.getAttribute("data-scroll-trigger-start") || "top center";
    const scrollTriggerEnd = element.getAttribute("data-scroll-trigger-end") || "bottom center";
    const scrollTriggerToggleActions = element.getAttribute("data-scroll-trigger-toggle-actions") || "play none none none";
    const scrollTriggerStartOffset = parseFloat(element.getAttribute("data-scroll-trigger-start-offset"));
    ...
    const animation = gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.from(element, animationConfig);
    if (autoPlay) {
      animation.play();
    }
  });
      ...
      _barba_core__WEBPACK_IMPORTED_MODULE_0___default().init({
        transitions: [{
          ...
          leave(data) {
            ...
            gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.to(data.current.container, {
              ...
              onComplete: () => {
                ...
                gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.set(data.current.container, {
                  height: 0,
                  marginTop: 0
                });
                done();
          ...
          enter(data) {
            ...
            gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.set(data.next.container, {
              opacity: 0
            });
