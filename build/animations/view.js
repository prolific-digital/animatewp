...
document.addEventListener("DOMContentLoaded", () => {
  document.querySelectorAll(".has-animation").forEach(element => {
    ...
    const animation = gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.from(element, animationConfig);
    if (autoPlay) {
      animation.play();
    }
  });
  document.querySelectorAll(".has-parallax").forEach(element => {
    ...
    gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.fromTo(element, {
      ...
      scrollTrigger: {
        trigger: element,
        start: "top bottom",
        // Trigger when the element starts entering the viewport
        end: "bottom top",
        // End the effect when the element is about to exit the viewport
        scrub: true,
